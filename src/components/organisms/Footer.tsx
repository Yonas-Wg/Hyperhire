...
const Footer = () => {
    return (
        <footer className=" footer flex flex-col items-start justify-start relative h-104 p-4 pl-80" style={{ backgroundColor: '#FBFBFB' }}>
            <div className="  flex flex-col items-start">
                ...
                <p className="mt-8 text-left text-gray-500 text-base leading-6 font-black">
                    010-0000-0000
                </p>
                <p className="mt-2 text-left text-gray-500 text-base leading-6 font-black">
                    aaaaa@naver.com
                </p>
        ...
        <div className="absolute footer2" style={{ left: '1080px', top: '19px', width: '187px', height: '142px', background: '#fff', borderRadius: '12px', padding: '16px', gap: '16px', display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
         <div style={{ 
            ...
            />
                ...
                <p className="text-[14px] font-bold leading-6 text-[#343741]" style={{ width: '184px',marginTop:'60px', height: '21px', fontFamily: 'Poppins', fontWeight: 900, marginLeft:'-10px' }}>
                외국인 원격 채용 (비개발)
                </p>
            </div>

            <div className="flex items-center">
            <p className="text-[14px] font-bold leading-6 text-[#343741]" style={{ marginTop: '0px', marginLeft: '0px' }}>
                바로가기
            </p>
            <svg 
                width="20" 
        ...
        <div className="absolute footer3" style={{ left: '1310px', top: '19px', width: '187px', height: '142px', background: '#fff', borderRadius: '12px', padding: '16px', gap: '16px', display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
         <div style={{ 
          ...
          sx={{ cursor: 'pointer', fontSize: 12, fontWeight: 'bold', color: 'grey', ml: -0.2, mt:0.2 }}
        >
          KOR
        </Typography>
    ...
    <p className="text-gray-600 text-base leading-6 font-black">주소 ADDRESS</p>
                    ...
                    <div className="flex footer6 justify-start space-x-4 md:space-x-52"> 
                        ...
                        <p className="text-gray-400 text-base leading-6 font-black pl-20">서울특별시 강남대로 479, 지하 1층 238호</p>
                    </div>
                </div>
                ...
                <div className="flex flex-col mt-4">
                    <div className="flex footer8 justify-start  space-x-4 md:space-x-8"> 
                        ...
                        <p className="text-right text-gray-400 text-base leading-6 font-black">
                            Juhyun Kim
                        </p>
                        <p className="text-right text-gray-400 text-base leading-6 font-black pl-44">
                            U74110DL2016PTC290812 
                        </p>
                        <p className="text-right text-gray-400 text-base leading-6 font-black pl-16">
                ...
                <p className="mt-12 text-left text-gray-500 text-base leading-6 font-black">
                    ⓒ 2023 Hyperhire
                </p>
            </div>
        </footer>
